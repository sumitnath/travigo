...
const Hero = ({ hero: { title, subtitle, btn1, btn2, text, img } }) => {
  return (
    <div
     ...
     from-emerald-200 to-white h-auto w-auto"
    >
      <div className="travigo-container grid items-start justify-items-center">
        <div
          className="grid items-center justify-center 
        mt-36 mb-16 md:mt-28 md:mb-12"
        >
          <h1
            className="text-7xl font-bold lg:text-6xl
          md:text-5xl sm:text-4xl xsm:text-3xl text-black filter drop-shadow-lg
          "
          >
            {title}
          </h1>
        ...
        <div className="flex items-center juatify-center mb-11">
          <img
            className="h-[85vh] w-full object-fill lg:h-[75vh] md:h-[57vh] 
        sm:h-[35vh] sm:object-contain drop-shadow-emrald"
            src={img}
            alt="dashboard/img"
          />
        </div>
